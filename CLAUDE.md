...
| Field | Value |
|---|---|
| Current phase | **3.5.0 built, release go pending** (fix-check-1, Kenny's Klopt 2026-09-20): `--check` reads the store and writes nothing (`Store::inspect`, `tests/fix_check_1.rs` red first). **v3.4.0 released and signed** (2026-09-20 19:48 UTC), not yet on CT 109; **v3.3.0 LIVE** there since 19:23 UTC |
