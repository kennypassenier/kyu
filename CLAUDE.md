...
| Last completed gate | Mini-round (2026-09-05): kp-themes v3.0.0 taken over, Bootstrap and its bridge removed, the dashboard rebuilt on the package's own components (2.4.0) |
| Next gate | None. kyu is released (2.4.0). Further work arrives as mini-rounds |
| AFK mode | off |
